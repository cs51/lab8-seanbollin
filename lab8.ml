...
let fakeId = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzzId = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire fakeId ;;
WEvent.remove_listener newswire buzzId ;;
